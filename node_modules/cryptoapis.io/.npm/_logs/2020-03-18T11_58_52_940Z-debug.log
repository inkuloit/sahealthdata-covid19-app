...
1 verbose cli   'i',
1 verbose cli   'tests/package.json'
1 verbose cli ]
2 info using npm@6.13.1
3 info using node@v12.13.0
4 verbose npm-session eeb7f237dddba2f1
5 silly install loadCurrentTree
6 silly install readLocalPackageData
7 silly fetchPackageMetaData error for github:tests/package.json Error while executing:
7 silly fetchPackageMetaData /usr/bin/git ls-remote -h -t ssh://git@github.com/tests/package.json.git
7 silly fetchPackageMetaData
7 silly fetchPackageMetaData git@github.com: Permission denied (publickey).
...
9 timing stage:runTopLevelLifecycles Completed in 2845ms
...
11 verbose cwd /app
12 verbose Linux 5.3.0-42-generic
13 verbose argv "/usr/local/bin/node" "/usr/local/bin/npm" "i" "tests/package.json"
14 verbose node v12.13.0
15 verbose npm  v6.13.1
16 error Error while executing:
16 error /usr/bin/git ls-remote -h -t ssh://git@github.com/tests/package.json.git
16 error
