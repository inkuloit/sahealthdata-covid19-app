...
const TableRow = props => {
    ...
    const link = `/projections?p=${province}`;
    return (
        <tr>
            <td className="align-middle tx-medium">{province}</td>
...
const CasesProvinces = props => {
    const { view, loaded, query } = props;
